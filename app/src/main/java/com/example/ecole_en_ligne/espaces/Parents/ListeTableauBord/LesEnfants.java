...
public class LesEnfants extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.les_enfants_parents);

        navigationView = findViewById(R.id.navigationPenf);
        drawerLayout = (DrawerLayout) findViewById(R.id.drawer_layout_enfP);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.tableau_bordP: {
                Intent redir = new Intent(LesEnfants.this, EspaceParents.class);
