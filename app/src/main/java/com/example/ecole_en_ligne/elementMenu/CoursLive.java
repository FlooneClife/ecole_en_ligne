...
public class CoursLive extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.tableau_bord: {
                ...
                Intent redir = new Intent(CoursLive.this, EspaceEleve.class);
            ...
            case R.id.cours_exos: {
                //ouvrir page des cours et des exercices
                Intent redir = new Intent(CoursLive.this, Cours_Exos.class);
                redir.putExtra("Login",i.getStringExtra("Login"));
                startActivity(redir);
                finish();
                break;
            ...
            case R.id.cours_live: {
                ...
                Intent redir = new Intent(CoursLive.this, CoursLive.class);
                redir.putExtra("Login",i.getStringExtra("Login"));
                startActivity(redir);
                finish();
                break;
            ...
            case R.id.recommandations: {
                ...
                Intent redir = new Intent(CoursLive.this, Recommandation.class);
                redir.putExtra("Login",i.getStringExtra("Login"));
                startActivity(redir);
                finish();
                break;
            ...
            case R.id.progression: {
                ...
                Intent redir = new Intent(CoursLive.this, Progression.class);
                redir.putExtra("Login",i.getStringExtra("Login"));
                startActivity(redir);
                finish();
                break;
            ...
            case R.id.activites: {
                ...
                Intent redir = new Intent(CoursLive.this, Activites.class);
                redir.putExtra("Login",i.getStringExtra("Login"));
                startActivity(redir);
                finish();
                break;
