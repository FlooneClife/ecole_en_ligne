...
public class Cinquieme extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(R.string.classe5e);
        ...
        connexion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent connexion = new Intent(Cinquieme.this, IndentificationC.class);
        ...
        inscription.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent connexion = new Intent(Cinquieme.this, Indentification_inscription.class);
                startActivity(connexion);
            }
        });
        ...
        propos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActionUtil.showOrangePopup(Cinquieme.this,
        ...
        contact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ConstraintLayout root = (ConstraintLayout) findViewById(R.id.root_layout);
                ActionUtil.showContactPopup(Cinquieme.this,
                        root);
            }
        });
