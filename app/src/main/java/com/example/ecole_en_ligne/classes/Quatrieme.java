...
public class Quatrieme extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(R.string.classe4e);
        ...
        connexion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent connexion = new Intent(Quatrieme.this, IndentificationC.class);
        ...
        inscription.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent connexion = new Intent(Quatrieme.this, Indentification_inscription.class);
                startActivity(connexion);
            }
        });
        ...
        propos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActionUtil.showOrangePopup(Quatrieme.this,
        ...
        contact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ConstraintLayout root = (ConstraintLayout) findViewById(R.id.root_layout);
                ActionUtil.showContactPopup(Quatrieme.this,
                        root);
            }
        });
