    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connexion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent connexion = new Intent(Sixieme.this, IndentificationC.class);
        ...
        inscription.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent connexion = new Intent(Sixieme.this, Indentification_inscription.class);
                startActivity(connexion);
            }
        });
        ...
        propos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActionUtil.showOrangePopup(Sixieme.this,
        ...
        contact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ConstraintLayout root = (ConstraintLayout) findViewById(R.id.root_layout);
                ActionUtil.showContactPopup(Sixieme.this,
                        root);
            }
        });
